...
namespace inventory_360.Controllers
{
    public class EquipmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Make,Model")] Equipment equipment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Make,Model")] Equipment equipment)
        {
            if (id != equipment.Id)
            {
                return NotFound();
